...
figure('Name','P1 1.2.1 PSD Unipolar NRZ','NumberTitle','off')
...
figure('Name','P1 1.2.2 PSD Bipolar NRZ','NumberTitle','off')
...
figure('Name','P1 1.2.3 PSD Bipolar RZ','NumberTitle','off')
...
figure('Name','P1 1.2.6 PSD Bipolar Nyquist','NumberTitle','off')
plot(f,Ss5); title('PSD Bipolar Nyquist')

%% Figure 7. Plot Manchester
figure('Name','P1 1.3. Plot PSD Manchester','NumberTitle','off')
subplot(3,1,1)
